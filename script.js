...
class GamingChatbot {
    constructor() {
        ...
        this.responses = {
            ...
            'contacto': [
                'Puedes contactar al creador Ace a través de: 📱 Teléfono: +56 9 5712 7950 (WhatsApp disponible). También en rebelnightcompany@gmail.com y Telegram @acedelgaming. Escribe directamente al creador y recibirás atención personalizada.', 
                'El creador Ace está disponible por: 📱 WhatsApp: +56957127950 | 📧 Email: rebelnightcompany@gmail.com | 💬 Telegram: @acedelgaming. ¡Escribe ahora para consultaría personalizada!'
            ],
            'ayuda': [
    ...
    bindEvents() {
        // Toggle chatbot
        this.chatbotFloatBtn.addEventListener('click', () => {
